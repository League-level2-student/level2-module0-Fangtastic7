...
public class _02_FindTheHiddenButton implements ActionListener{
	...
	public void start() {
		...
		String answer = JOptionPane.showInputDialog("Give me a positive number!");
		int number = Integer.parseInt(answer);
		//4. Initialize the array of JButtons to be the size of the int created in step 3
		
		array = new JButton[number];
		...
		JOptionPane.showMessageDialog(null, "Click a button that says 'Me'!");
		...
		array[hiddenButton].setText(null);
	}
